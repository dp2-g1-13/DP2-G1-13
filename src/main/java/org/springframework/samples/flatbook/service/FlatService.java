...
public class FlatService {
	...
	@Autowired
	public FlatService(final FlatRepository flatRepository, final DBImageRepository dbImageRepository, final AddressRepository addressRepository,
                       final TenantRepository tenantRepository, final AdvertisementRepository advertisementRepository, final RequestRepository requestRepository,
	...
	@Transactional(readOnly = true)
	public Collection<Tenant> findTenantsById(final int id) {
