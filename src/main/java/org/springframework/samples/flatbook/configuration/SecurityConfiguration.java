...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/users/{reportId:[0-9a-zA-Z]{5,}}").permitAll()
				.antMatchers("/users/{reportId:[0-9a-zA-Z]{5,}}/unban").hasAnyAuthority("ADMIN")
				.antMatchers("/users/{reportId:[0-9a-zA-Z]{5,}}/ban").hasAnyAuthority("ADMIN")
				.antMatchers("/users/{reportId:[0-9a-zA-Z]{5,}}/edit").hasAnyAuthority("HOST", "TENANT")
				.antMatchers("/users/{reportId:[0-9a-zA-Z]{5,}}/editPassword").hasAnyAuthority("HOST", "TENANT")
                ...
                .antMatchers("/flats/{flatId:[0-9]+}/requests/list").hasAnyAuthority("HOST", "ADMIN")
				...
				.antMatchers("/reports/{reportId:[0-9a-zA-Z]{5,}}/new").hasAnyAuthority("HOST", "TENANT")
				.antMatchers("/statistics").hasAnyAuthority("ADMIN")
				.antMatchers("/reports/list").hasAnyAuthority("ADMIN")
				.antMatchers("/reports/{reportId:[0-9a-zA-Z]{5,}}/list").hasAnyAuthority("ADMIN")
				.anyRequest().denyAll()
				.and()
				 	.formLogin()
				 	/*.loginPage("/login")*/
