...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/users/{username:[0-9a-zA-Z]{5,}}/editPassword").hasAnyAuthority(AuthoritiesType.HOST.toString(), AuthoritiesType.TENANT.toString())
                .antMatchers("/advertisements/{advertisementId:[0-9]+}").permitAll()
                .antMatchers("/advertisements").permitAll()
                .antMatchers("/advertisements/{advertisementId:[0-9]+}/edit").hasAnyAuthority(AuthoritiesType.HOST.toString(), AuthoritiesType.ADMIN.toString())
                .antMatchers("/advertisements/{advertisementId:[0-9]+}/delete").hasAnyAuthority(AuthoritiesType.HOST.toString(), AuthoritiesType.ADMIN.toString())
                ...
                .antMatchers("/requests/list").hasAuthority(AuthoritiesType.TENANT.toString())
				.antMatchers("/flats/{flatId:[0-9]+}").hasAnyAuthority(AuthoritiesType.HOST.toString(), AuthoritiesType.ADMIN.toString(), AuthoritiesType.TENANT.toString())
                ...
                .antMatchers("/flats/new").hasAnyAuthority(AuthoritiesType.HOST.toString())
                .antMatchers("/flats/list").hasAuthority(AuthoritiesType.HOST.toString())
                .antMatchers("/reviews/**").hasAnyAuthority(AuthoritiesType.HOST.toString(), AuthoritiesType.TENANT.toString())
				.antMatchers("/messages/**").hasAnyAuthority(AuthoritiesType.HOST.toString(), AuthoritiesType.TENANT.toString())
				.antMatchers("/tasks/**").hasAuthority(AuthoritiesType.TENANT.toString())
				.antMatchers("/logout").permitAll()
				.antMatchers("/reports/{username:[0-9a-zA-Z]{5,}}/new").hasAnyAuthority(AuthoritiesType.HOST.toString(), AuthoritiesType.TENANT.toString())
				.antMatchers("/statistics").hasAnyAuthority(AuthoritiesType.ADMIN.toString())
				.antMatchers("/reports/list").hasAnyAuthority(AuthoritiesType.ADMIN.toString())
