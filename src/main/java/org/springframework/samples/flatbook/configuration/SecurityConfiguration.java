...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		http.authorizeRequests()
                ...
                .antMatchers("/advertisements/{advertisementId:[0-9]+}/requests/new").hasAnyAuthority("TENNANT")
                ...
                .antMatchers("/requests/list").hasAuthority("TENNANT")
                .antMatchers("/advertisements/**").permitAll()
                .antMatchers("/flats/{flatId:[0-9]+}/reviews/**").hasAnyAuthority("TENNANT")
				...
				.antMatchers("/tasks/**").hasAuthority("TENNANT")
				.antMatchers("/tennants/**").fullyAuthenticated()
                .antMatchers("/advertisements/**").permitAll()
