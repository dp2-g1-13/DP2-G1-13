...
class UH14PerformanceTest extends Simulation {
	...
	object AdvertisementWithReviews { 
		val advertisementWithReviews = exec(http("AdvertisementWithReviews")
	...
	val loadUserPage = scenario("LoadUserPage")
		...
		AdvertisementWithReviews.advertisementWithReviews)
