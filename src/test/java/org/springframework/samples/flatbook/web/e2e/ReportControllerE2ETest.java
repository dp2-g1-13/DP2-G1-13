...
public class ReportControllerE2ETest {
	...
	@WithMockUser(username = ReportControllerE2ETest.USERNAME1, authorities = ReportControllerE2ETest.TENANT_USER)
	@Test
	void testInitCreationForm() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/reports/{userId}/new", ReportControllerE2ETest.USERNAME2))
	...
	@WithMockUser(username = ReportControllerE2ETest.ADMIN_USER, authorities = ReportControllerE2ETest.ADMIN_USER)
	@Test
	...
	void testInitCreationFormThrowExceptionBadReportedUsername() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/reports/{userId}/new", ReportControllerE2ETest.TEST_BAD_REPORTED_USERNAME))
	...
	void testProcessCreationForbiddenForAdmin() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/reports/{userId}/new", ReportControllerE2ETest.USERNAME2)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("creationDate", "01/01/2005").param("reason", "reason")
				.param("receiver", ReportControllerE2ETest.USERNAME2).param("sender", ReportControllerE2ETest.ADMIN_USER))
			.andExpect(MockMvcResultMatchers.status().isForbidden());
	}
	...
	void testProcessCreationFormSuccess() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/reports/{userId}/new", ReportControllerE2ETest.USERNAME2)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("creationDate", "01/01/2005").param("reason", "reason")
				.param("receiver", ReportControllerE2ETest.USERNAME2).param("sender", ReportControllerE2ETest.USERNAME1))
	...
	void testProcessCreationFormThrowExceptionBadReportedUsername() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/reports/{userId}/new", ReportControllerE2ETest.TEST_BAD_REPORTED_USERNAME)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("creationDate", "01/01/2005").param("reason", "reason")
				.param("receiver", ReportControllerE2ETest.TEST_BAD_REPORTED_USERNAME).param("sender", ReportControllerE2ETest.USERNAME1))
			.andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("exception"));
	}
	...
	void testProcessCreationFormHasErrors() throws Exception {
		...
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/reports/{userId}/new", ReportControllerE2ETest.USERNAME2)
				...
				.param("sender", ReportControllerE2ETest.USERNAME1))
	...
	void testInitUserReportList() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/reports/{userId}/list", ReportControllerE2ETest.USERNAME2))
	...
	void testProcessReportRemovalForbiddenForNotAdmin() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/reports/{reportId}/delete", ReportControllerE2ETest.TEST_REPORT_ID))
			.andExpect(MockMvcResultMatchers.status().isForbidden());
	}
