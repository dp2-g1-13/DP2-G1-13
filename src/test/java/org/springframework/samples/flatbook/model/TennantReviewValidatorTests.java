...
public class TennantReviewValidatorTests {
    ...
    void shouldNotValidateWhenRateNull() {
        ...
        Set<ConstraintViolation<TennantReview>> constraintViolations = validator.validate(review);
        
        assertThat(constraintViolations.size()).isEqualTo(1);
        ConstraintViolation<TennantReview> violation = constraintViolations.iterator().next();
